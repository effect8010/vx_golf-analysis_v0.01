...
# 원본 배치 파일: generate-sample-data.bat
# 변환 일시: 2025-03-14T05:40:47.389Z
...
Write-Host "골프 시뮬레이터 분석 서비스 - 샘플 데이터 생성"
Write-Host "==========================================="
# 원본 명령어 (수동 확인 필요): echo.
Write-Host "샘플 데이터를 생성합니다..."
# 
# 원본 명령어 (수동 확인 필요): "C:\Program Files\nodejs\node.exe" scripts\generate-sample-data.js
# 
# 원본 명령어 (수동 확인 필요): echo.
Write-Host "샘플 데이터 생성이 완료되었습니다."
# 원본 명령어 (수동 확인 필요): echo.
# 
